...
while 1:
    ...
    #-------------------------------
        ...
        for c in contours:
            ...
            print("percent area = ", percent * 100)
            a = percent * 100
            if a > 100 and a < 200:
                print("stitch is fine")
                # ser_data.write(b'X')
                print("X")
                # time.sleep(1)
            elif a < 50 :
                print("stitch is improper")
                cv2.imwrite("fault_image.jpg",frame0)
                # ser_data.write(b'A')
                print("A")
